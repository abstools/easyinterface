...
\lstdefinelanguage{XML}
{
  ...
  keywords=[1]{id,visible,src,format,prefix,url,widgetid,name,max_size,method,check,value,version,from,to,fromch,toch,dest,autoclean,outclass,consoleid,consoletitle,color,filename,boxtitle,boxheight,boxwidth,path,repo,owner,branch,explicit,multiline,passinfile,selectable,icon,text},
