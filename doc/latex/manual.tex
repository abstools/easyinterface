...
\newcommand{\eidownloadurl}[0]{\url{http://www.envisage-project.eu/easyinterface}\xspace}

% web client

\newcommand{\applybutton}[0]{
\begingroup
\setlength{\fboxsep}{0pt}%  
\colorbox{blue!20}{\texttt{Apply}}\xspace
\endgroup
}

\newcommand{\refreshoutline}[0]{
\begingroup
\setlength{\fboxsep}{0pt}%  
\colorbox{blue!20}{\texttt{Refresh Outline}}\xspace
\endgroup
}

\newcommand{\settingbutton}[0]{
\begingroup
\setlength{\fboxsep}{0pt}%  
\colorbox{blue!20}{\texttt{Settings}}\xspace
\endgroup
}
