...
** FEEDBACK Time line command
It could be:
<timeline widget="cosole|dialog" title="TEXT" auto="SECONDS">
(<step autoclean="BOOLEAN">
<eicommand>
...
</eicommand>
</step>)*
...
And to solve the streaming problem we can add a command: askUrl
It seems:
<askUrl delay="SECONDS" tries="NUMBER" url="PATH" />
